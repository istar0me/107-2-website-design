            ...
            <div class="container-fluid" style="padding: 20px">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Username" DataSourceID="SqlDataSource2" AllowPaging="True" CssClass="table table-striped table-borderless border-top-0 border-right-0 border-bottom-0 border-left-0">
                            <Fields>
                                <asp:BoundField DataField="Username" HeaderText="帳號" ReadOnly="True" SortExpression="Username"></asp:BoundField>
                                <asp:BoundField DataField="Password" HeaderText="密碼" SortExpression="Password"></asp:BoundField>
